...
const contestTime = new Date("2026-04-18T09:15:00.000-07:00");
const signupsEnded = new Date("2026-04-15T23:59:59.000-07:00");

// Formal text for contest time
const contestTimeString = "April 18, 2026, 9:15AM";
...
// 2: Default
const splashTexts = [
	"Thanks for joining SCPE Spring 2026! Check back for the next SCPE!",
	"Signups have ended! See you at the contest!",
	"Register using the link below!"
];

// Link to actual contest: make sure to put the "https://"
const contestLink = "https://www.hackerrank.com/scpe-spring-2026";

// Link to signup form: make sure to put the "https://"
const registrationLink = "https://docs.google.com/forms/d/e/1FAIpQLSdIC5l6NPRQIaa2O1P13zrxh4gqqJ2dqbtkwFyQw_PNo7fH8g/viewform";
new Vue({
	el: '#timer',
	data: {
		contestTime:[],
